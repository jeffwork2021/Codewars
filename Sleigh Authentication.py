...
# password. If, and only if, the name equals "Santa Claus" and the password is 
# "Ho Ho Ho!" (yes, even Santa has a secret password with uppercase and 
# lowercase letters and special characters :D), the return value must be true. 
...
# sleigh.authenticate('jhoffner', 'CodeWars') # Nope, even Jake is not allowed 
# to use the sleigh ;)
class Sleigh(object):
