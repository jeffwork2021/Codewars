...
#
# Note to Tax: not the invested principal is taxed, but only the year's accrued 
# interest
#
# Example:
#
...
#
# Assumption: Assume that Desired Principal 'D' is always greater than the 
...
def calculate_years(principal, interest, tax, desired):
    return 0 if principal >= desired \
                else math.ceil(math.log(desired/principal) /
