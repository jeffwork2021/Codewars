...
#
#     gap(2, 5, 5) --> nil. In C++ {0, 0}. In F# [||]. In Kotlin, Dart and 
# Prolog return []`
#
...
# first pair)
#
#     gap(6,100,110) --> nil or {0, 0} or ... : between 100 and 110 we have 
# 101, 103, 107, 109 but 101-107is not a 6-gap because there is 103in between 
