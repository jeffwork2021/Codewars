...
# motif at most N times. Luckily, Alice and Bob are able to encode the motif as 
# a number. Can you help them to remove numbers such that their list contains 
...
# For example if the input number is 2, and the input list is [1,2,3,1,2,1,2,
# 3], you take [1,2,3,1,2], drop the next [1,2] since this would lead to 1 and 
