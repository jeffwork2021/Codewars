...
# you either freeze when you realise you are dead, or swim when you realise you 
# can make it!
#
...
def shark(pontoon_distance, shark_distance, you_speed, shark_speed, dolphin):
    ...
    return "Alive!" if (shark_distance/shark_speed - \
                        pontoon_distance/you_speed) > 0 else "Shark Bait!" 
